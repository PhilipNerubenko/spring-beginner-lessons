package com.philip.spring.spring_course.hibernate_one_to_one.entity;
...
public class Employee {
  ...
  @OneToOne(cascade = CascadeType.ALL) @JoinColumn(name = "details_id") private Detail empDetail;
  ...
  public String toString() {
    return "Employee [id=" + id + ", firstName=" + firstName + ", surname=" + surname
        + ", department=" + department + ", salary=" + salary + ", empDetail=" + empDetail + "]";
  }
}