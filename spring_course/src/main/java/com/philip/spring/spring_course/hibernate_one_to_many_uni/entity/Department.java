package com.philip.spring.spring_course.hibernate_one_to_many_uni.entity;
...
public class Department {
  ...
  @Column(name = "name") private String departmentName;

  @Column(name = "max_salary") private int maxSalary;

  @Column(name = "min_salary") private int minSalary;
